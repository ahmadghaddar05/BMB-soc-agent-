...
function validateSetting(key, value) {
  ...
  if (key === 'llm_provider' && !['hermes','nous'].includes(text)) return 'llm_provider is unsupported (use hermes or nous)';
  ...
  if (key === 'nous_model' && !/^[A-Za-z0-9._:/-]{1,200}$/.test(text)) return 'nous_model contains unsupported characters';
