...
const POLICY_VERSION = 'phase7-v1';
...
function normalize(actionType, targetId, parameters) {
  ...
  if (!policy) throw new ActionError('ACTION_FORBIDDEN', 'This action is not allowed by the Phase 7 policy', 403);
    ...
    try {
      ...
      const inserted = await client.query(
        `INSERT INTO action_requests(run_id,action_type,target_type,target_id,requested_by,status,
          parameters,reason,policy_version,approval_required,idempotency_key)
         VALUES($1,$2,$3,$4,$5,'pending',$6,$7,$8,$9,$10)
         ON CONFLICT (idempotency_key) WHERE idempotency_key IS NOT NULL DO NOTHING
         RETURNING *`,
        [runId, actionType, normalized.policy.targetType, normalized.targetId, actor,
          normalized.parameters, why, POLICY_VERSION, normalized.policy.approvalRequired, key]
      );
