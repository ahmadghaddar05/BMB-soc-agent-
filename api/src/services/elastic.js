...
const RAW_EVENT_FIELDS = [
  ...
  'process.pid', 'process.hash.sha256', 'process.code_signature.trusted',
  'process.parent.name', 'process.parent.executable', 'process.parent.command_line',
  'process.parent.entity_id', 'process.parent.pid', 'process.parent.hash.sha256',
  'file.name', 'file.path', 'file.size', 'file.mime_type', 'file.hash.sha256',
