...
import { AlertOctagon, Box, CircleCheck, Filter, Search, Server, ShieldAlert, TriangleAlert } from 'lucide-react';
...
export default function Vulnerabilities() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(loadError.message || 'Exposure evidence could not be loaded.');
  ...
  const selected = filtered.find(row => String(row.id) === String(selectedId)) || filtered[0] || null;
  ...
  return <div className="module-page vuln-page">
    <div className="module-hero compact"><div><span className="eyebrow"><ShieldAlert />Exposure evidence</span><h2>Vulnerabilities</h2><p>Structured enrichment findings plus exploit-related signals found in the latest 100 stored alerts; this is not a complete vulnerability inventory.</p></div></div>
